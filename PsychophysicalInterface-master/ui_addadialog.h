...
public:
    ...
    void setupUi(QDialog *AddADialog)
    {
        ...
        formLayout->setWidget(0, QFormLayout::FieldRole, trialnameEdit);

        channelLabel = new QLabel(frame);
        channelLabel->setObjectName("channelLabel");

        formLayout->setWidget(2, QFormLayout::LabelRole, channelLabel);

        channelEdit = new QLineEdit(frame);
        channelEdit->setObjectName("channelEdit");

        formLayout->setWidget(2, QFormLayout::FieldRole, channelEdit);
        ...
        formLayout->setWidget(3, QFormLayout::FieldRole, frequencyEdit);
        ...
        formLayout->setWidget(4, QFormLayout::FieldRole, dutycycleEdit);
        ...
        formLayout->setWidget(5, QFormLayout::FieldRole, cycleoffsetEdit);

        onsetLabel = new QLabel(frame);
        onsetLabel->setObjectName("onsetLabel");

        formLayout->setWidget(6, QFormLayout::LabelRole, onsetLabel);

        onsetEdit = new QLineEdit(frame);
        onsetEdit->setObjectName("onsetEdit");

        formLayout->setWidget(6, QFormLayout::FieldRole, onsetEdit);

        offsetLabel = new QLabel(frame);
        offsetLabel->setObjectName("offsetLabel");

        formLayout->setWidget(7, QFormLayout::LabelRole, offsetLabel);

        offsetEdit = new QLineEdit(frame);
        offsetEdit->setObjectName("offsetEdit");

        formLayout->setWidget(7, QFormLayout::FieldRole, offsetEdit);
        ...
        formLayout->setLayout(8, QFormLayout::SpanningRole, horizontalLayout_2);

        trialdurationEdit = new QLineEdit(frame);
        trialdurationEdit->setObjectName("trialdurationEdit");

        formLayout->setWidget(1, QFormLayout::FieldRole, trialdurationEdit);

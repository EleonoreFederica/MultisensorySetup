...
Auditory_Stimulus::Auditory_Stimulus(int _channel, int _onset, int _offset, float _frequency, float _duty_cycle, int _cycle_offset) : channel(_channel), onset(_onset), offset(_offset), frequency(_frequency), duty_cycle(_duty_cycle), cycle_offset(_cycle_offset)
{
